...
- [x] 05-02-PLAN.md — src/dashboard/plots.py: constructores puros de figuras (choropleth animado con range_color fijo, gráfico de escenarios, PDP) + tests (DASH-04)
- [x] 05-03-PLAN.md — src/dashboard/data.py: loaders cacheados (cache_resource/cache_data) + recálculo en vivo de bootstrap/SHAP (D-03), solo artefactos locales (DASH-01, DASH-02)
...
- [x] 06-02-PLAN.md — src/model2_agri.py: pipeline completo del Modelo 2 (fit, diagnósticos, robustez, bootstrap, heterogeneidad, SHAP, tabla de cobertura, serialización) (MODEL2-01, MODEL2-02, MODEL2-03)
